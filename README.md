...
- Get mah boi claude to whip a module to boot the sonnet g3 card and load linux onto it. (done)
  - https://github.com/fifteenhex/sonnetd
  - https://github.com/fifteenhex/sonnetfw
